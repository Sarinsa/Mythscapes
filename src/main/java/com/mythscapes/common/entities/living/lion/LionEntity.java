package com.mythscapes.common.entities.living.lion;

import com.mythscapes.register.MythEntities;
import com.mythscapes.register.MythSounds;
...
public class LionEntity extends AnimalEntity {
    ...
    protected SoundEvent getAmbientSound() {
        return MythSounds.LION_IDLE.get();
    }
    ...
    //                          GOALS
    //-----------------------------------------------------------------
    private class LionMeleeAttackGoal extends MeleeAttackGoal {

        public LionMeleeAttackGoal() {
            super(LionEntity.this, 1.3D, true);
        }
