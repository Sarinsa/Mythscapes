...
public class MythBlocks {
    ...
    public static final RegistryObject<Block> POWERED_GALVITE = BLOCKS.register("powered_galvite", () -> new RedstoneOreBlock(Block.Properties.from(GILDED_GALVITE.get()).tickRandomly().setLightLevel(lightValueLit(9))));
    ...
    public static final RegistryObject<Block> WOLT_WOOD = BLOCKS.register("wolt_wood", () -> new ModLogBlock(Block.Properties.create(Material.WOOD, MaterialColor.ICE).sound(SoundType.WOOD).hardnessAndResistance(2.0f)));
    public static final RegistryObject<Block> WOLT_LOG_STRIPPED = BLOCKS.register("wolt_log_stripped", () -> new ModLogBlock(Block.Properties.create(Material.WOOD, MaterialColor.ICE).sound(SoundType.WOOD).hardnessAndResistance(2.0f, 3.0f)));
    public static final RegistryObject<Block> WOLT_WOOD_STRIPPED = BLOCKS.register("wolt_wood_stripped", () -> new ModLogBlock(Block.Properties.from(WOLT_WOOD.get())));
    public static final RegistryObject<Block> WOLT_PLANKS = BLOCKS.register("wolt_planks", () -> new ModPlanksBlock(Block.Properties.create(Material.WOOD, MaterialColor.ICE).sound(SoundType.WOOD).hardnessAndResistance(2.0f, 3.0f)));
    public static final RegistryObject<Block> WOLT_SLAB = BLOCKS.register("wolt_slab", () -> new ModWoodSlabBlock(Block.Properties.create(Material.WOOD, MaterialColor.ICE).sound(SoundType.WOOD).hardnessAndResistance(2.0f, 3.0f)));
    public static final RegistryObject<Block> WOLT_STAIRS = BLOCKS.register("wolt_stairs", () -> new ModWoodStairsBlock(WOLT_PLANKS.get()::getDefaultState, Block.Properties.create(Material.WOOD, MaterialColor.ICE).sound(SoundType.WOOD).hardnessAndResistance(2.0f, 3.0f)));
    public static final RegistryObject<Block> WOLT_FENCE = BLOCKS.register("wolt_fence", () -> new ModFenceBlock(Block.Properties.create(Material.WOOD, MaterialColor.ICE).sound(SoundType.WOOD).hardnessAndResistance(2.0f, 3.0f)));
    public static final RegistryObject<Block> WOLT_FENCE_GATE = BLOCKS.register("wolt_fence_gate", () -> new ModFenceGateBlock(Block.Properties.create(Material.WOOD, MaterialColor.ICE).sound(SoundType.WOOD).hardnessAndResistance(2.0f, 3.0f)));
    ...
    public static final RegistryObject<Block> WOLT_SAPLING = BLOCKS.register("wolt_sapling", () -> new ModSaplingBlock(Block.Properties.create(Material.PLANTS, MaterialColor.CYAN).sound(SoundType.PLANT).hardnessAndResistance(0.0f).doesNotBlockMovement().tickRandomly()));
    ...
    */
    ...
    // Leaves
    //
    public static final RegistryObject<Block> WOLT_LEAVES = BLOCKS.register("wolt_leaves", () -> new ModLeavesBlock(Block.Properties.create(Material.LEAVES, MaterialColor.CYAN).sound(SoundType.PLANT).hardnessAndResistance(0.2F).tickRandomly().notSolid()));
    ...
    // Trollstone
    //
    public static final RegistryObject<Block> TROLLSTONE = BLOCKS.register("trollstone", () -> new Block(Block.Properties.create(Material.ROCK, MaterialColor.LIGHT_GRAY).sound(SoundType.STONE).hardnessAndResistance(0.4f)));
    public static final RegistryObject<Block> TROLLSTONE_SLAB = BLOCKS.register("trollstone_slab", () -> new SlabBlock(Block.Properties.from(TROLLSTONE.get())));
    public static final RegistryObject<Block> TROLLSTONE_STAIRS = BLOCKS.register("trollstone_stairs", () -> new StairsBlock(TROLLSTONE.get()::getDefaultState, Block.Properties.from(TROLLSTONE.get())));
    public static final RegistryObject<Block> TROLLSTONE_WALL = BLOCKS.register("trollstone_wall", () -> new WallBlock(Block.Properties.from(TROLLSTONE.get())));
    public static final RegistryObject<Block> POLISHED_TROLLSTONE = BLOCKS.register("polished_trollstone", () -> new Block(Block.Properties.from(TROLLSTONE.get())));
    public static final RegistryObject<Block> POLISHED_TROLLSTONE_SLAB = BLOCKS.register("polished_trollstone_slab", () -> new SlabBlock(Block.Properties.from(TROLLSTONE.get())));
    public static final RegistryObject<Block> POLISHED_TROLLSTONE_STAIRS = BLOCKS.register("polished_trollstone_stairs", () -> new StairsBlock(POLISHED_TROLLSTONE.get()::getDefaultState, Block.Properties.from(TROLLSTONE.get())));
    public static final RegistryObject<Block> POLISHED_TROLLSTONE_WALL = BLOCKS.register("polished_trollstone_wall", () -> new WallBlock(Block.Properties.from(TROLLSTONE.get())));
    public static final RegistryObject<Block> POLISHED_TROLLSTONE_PRESSURE_PLATE = BLOCKS.register("polished_trollstone_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, Block.Properties.from(TROLLSTONE.get())));
    public static final RegistryObject<Block> POLISHED_TROLLSTONE_BUTTON = BLOCKS.register("polished_trollstone_button", () -> new StoneButtonBlock(Block.Properties.from(TROLLSTONE.get())));
    public static final RegistryObject<Block> POLISHED_TROLLSTONE_BRICKS = BLOCKS.register("polished_trollstone_bricks", () -> new Block(Block.Properties.from(TROLLSTONE.get())));
    public static final RegistryObject<Block> POLISHED_TROLLSTONE_BRICK_SLAB = BLOCKS.register("polished_trollstone_brick_slab", () -> new SlabBlock(Block.Properties.from(TROLLSTONE.get())));
    public static final RegistryObject<Block> POLISHED_TROLLSTONE_BRICK_STAIRS = BLOCKS.register("polished_trollstone_brick_stairs", () -> new StairsBlock(POLISHED_TROLLSTONE_BRICKS.get()::getDefaultState, Block.Properties.from(TROLLSTONE.get())));
    public static final RegistryObject<Block> POLISHED_TROLLSTONE_BRICK_WALL = BLOCKS.register("polished_trollstone_brick_wall", () -> new WallBlock(Block.Properties.from(TROLLSTONE.get())));
    public static final RegistryObject<Block> POLISHED_TROLLSTONE_PILLAR = BLOCKS.register("polished_trollstone_pillar", () -> new RotatedPillarBlock(Block.Properties.from(TROLLSTONE.get())));
    public static final RegistryObject<Block> CHISELED_POLISHED_TROLLSTONE = BLOCKS.register("chiseled_polished_trollstone", () -> new Block(Block.Properties.from(TROLLSTONE.get())));
    ...
    public static final RegistryObject<Block> BIOBULB_CLUSTER = BLOCKS.register("biobulb_cluster", () -> new Block(Block.Properties.create(Material.GLASS, MaterialColor.CYAN).sound(SoundType.GLASS).hardnessAndResistance(0.3f).setLightLevel((state) -> 13).harvestTool(ToolType.AXE)));
    ...
    public static final RegistryObject<Block> BIOBULB_LAMP = BLOCKS.register("biobulb_lamp", () -> new RedstoneLampBlock(Block.Properties.create(Material.REDSTONE_LIGHT, MaterialColor.GREEN).sound(SoundType.GLASS).hardnessAndResistance(0.3F).setLightLevel(lightValueLit(15))));
    ...
    public static final RegistryObject<Block> STATIC_COTTON_PILES = BLOCKS.register("static_cotton_piles", () -> new StaticCottonPilesBlock(Block.Properties.create(Material.WOOL, MaterialColor.WHITE_TERRACOTTA).sound(SoundType.CLOTH).hardnessAndResistance(0.8f)));
    ...
    // Fluid Blocks
    //
    public static final RegistryObject<FlowingFluidBlock> LIQUID_SULFUR_FLUID_BLOCK = BLOCKS.register("liquid_sulfur_block", () -> new LiquidSulphurFluidBlock(MythFluids.SULFUR, Block.Properties.create(Material.WATER, MaterialColor.YELLOW).doesNotBlockMovement().hardnessAndResistance(100.0f).noDrops()));
