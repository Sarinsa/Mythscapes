...
import com.mythscapes.common.blocks.*;
...
import com.mythscapes.common.blocks.stone.MythStoneButtonBlock;
import com.mythscapes.common.blocks.wood.MythSaplingBlock;
import com.mythscapes.common.blocks.wood.MythWoodButtonBlock;
...
import static net.minecraft.block.material.Material.WOOL;
...
public class MythBlocks {
    ...
    public static final RegistryObject<Block> WOLT_PRESSURE_PLATE = BLOCKS.register("wolt_pressure_plate", () -> new MythPressurePlateBlock(Block.Properties.create(Material.WOOD, MaterialColor.ICE).sound(SoundType.WOOD).hardnessAndResistance(0.5f)));
    public static final RegistryObject<Block> WOLT_BUTTON = BLOCKS.register("wolt_button", () -> new MythWoodButtonBlock(Block.Properties.create(Material.WOOD, MaterialColor.ICE).sound(SoundType.WOOD).hardnessAndResistance(0.5f)));
    public static final RegistryObject<Block> WOLT_DOOR = BLOCKS.register("wolt_door", () -> new MythDoorBlock(Block.Properties.create(Material.WOOD, MaterialColor.ICE).sound(SoundType.WOOD).hardnessAndResistance(3.0f).notSolid()));
    public static final RegistryObject<Block> WOLT_TRAPDOOR = BLOCKS.register("wolt_trapdoor", () -> new MythTrapDoorBlock(Block.Properties.create(Material.WOOD, MaterialColor.ICE).sound(SoundType.WOOD).hardnessAndResistance(3.0f).notSolid()));
    ...
    public static final RegistryObject<Block> VIRIDIAN_PRESSURE_PLATE = BLOCKS.register("viridian_pressure_plate", () -> new MythPressurePlateBlock(Block.Properties.create(Material.WOOD, MaterialColor.GREEN).sound(SoundType.WOOD).hardnessAndResistance(0.5f)));
    public static final RegistryObject<Block> VIRIDIAN_BUTTON = BLOCKS.register("viridian_button", () -> new MythWoodButtonBlock(Block.Properties.create(Material.WOOD, MaterialColor.GREEN).sound(SoundType.WOOD).hardnessAndResistance(0.5f)));
    ...
    public static final RegistryObject<Block> POLISHED_GALVITE_PRESSURE_PLATE = BLOCKS.register("polished_galvite_pressure_plate", () -> new MythPressurePlateBlock(Block.Properties.from(GALVITE.get())));
    public static final RegistryObject<Block> POLISHED_GALVITE_BUTTON = BLOCKS.register("polished_galvite_button", () -> new MythStoneButtonBlock(Block.Properties.from(GALVITE.get())));
    ...
    public static final RegistryObject<Block> GILDED_GALVITE = BLOCKS.register("gilded_galvite", () -> new OreBlock(Block.Properties.from(GALVITE.get()).hardnessAndResistance(3.0f)));
    ...
    public static final RegistryObject<Block> STATIC_COTTON_BLOCK = BLOCKS.register("static_cotton_block", () -> new StaticCottonBlock(Block.Properties.create(WOOL, MaterialColor.WHITE_TERRACOTTA).sound(SoundType.CLOTH).hardnessAndResistance(0.8f)));
    public static final RegistryObject<Block> STATIC_COTTON_LAYERS = BLOCKS.register("static_cotton_layers", () -> new StaticCottonLayersBlock(Block.Properties.create(WOOL, MaterialColor.WHITE_TERRACOTTA).sound(SoundType.CLOTH).hardnessAndResistance(0.8f)));
