...
public class MythChestTileEntityRenderer<T extends MythChestTileEntity> extends TileEntityRenderer<T> {
    ...
    public void render(T tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
        ...
        BlockState blockstate = flag ? tileEntityIn.getBlockState() : itemRenderBlock.getDefaultState().with(ChestBlock.FACING, Direction.SOUTH);
        ...
        if (block instanceof MythChestBlock) {
            ...
            if (flag) {
                icallbackwrapper = chestBlock.combine(blockstate, world, tileEntityIn.getPos(), true);
            } else {
            ...
            if (this.isChristmas) {
                vertexBuilder = Atlases.getChestMaterial(tileEntityIn, chesttype, this.isChristmas).getBuffer(bufferIn, RenderType::getEntityCutout);
            }
            else {
                vertexBuilder = bufferIn.getBuffer(RenderType.getEntityCutoutNoCull(this.getChestTexture(block, chesttype)));
            }
