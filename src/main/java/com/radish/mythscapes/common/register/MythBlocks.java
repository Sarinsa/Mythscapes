...
public class MythBlocks {
    ...
    */
    ...
    // Misc
    public static final RegistryObject<Block> WOLT_POWDER_BLOCK = registerBlock("wolt_powder_block", () -> new WoltPowderBlock(false, AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_GREEN).sound(SoundType.STONE).strength(0.5f).harvestTool(ToolType.PICKAXE)));
    public static final RegistryObject<Block> GOLDEN_WOLT_POWDER_BLOCK = registerBlock("golden_wolt_powder_block", () -> new WoltPowderBlock(true, AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_YELLOW).sound(SoundType.STONE).strength(0.5f).harvestTool(ToolType.PICKAXE)));
