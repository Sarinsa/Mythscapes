...
public class MythBlocks {
    ...
    public static final RegistryObject<Block> WOLT_FENCE = BLOCKS.register("wolt_fence", () -> new ModWoodFenceBlock(AbstractBlock.Properties.create(Material.WOOD, MaterialColor.ICE).sound(SoundType.WOOD).hardnessAndResistance(2.0f, 3.0f)));
    public static final RegistryObject<Block> WOLT_FENCE_GATE = BLOCKS.register("wolt_fence_gate", () -> new ModWoodFenceGateBlock(AbstractBlock.Properties.create(Material.WOOD, MaterialColor.ICE).sound(SoundType.WOOD).hardnessAndResistance(2.0f, 3.0f)));
    ...
    */
    ...
    public static final RegistryObject<Block> SNAIL_SHELL_BRICK_SLAB = BLOCKS.register("snail_shell_brick_slab", () -> new SlabBlock(AbstractBlock.Properties.from(SNAIL_SHELL_BRICKS.get())));
    public static final RegistryObject<Block> SNAIL_SHELL_BRICK_STAIRS = BLOCKS.register("snail_shell_brick_stairs", () -> new StairsBlock(SNAIL_SHELL_BLOCK.get()::getDefaultState, AbstractBlock.Properties.from(SNAIL_SHELL_BLOCK.get())));
    public static final RegistryObject<Block> SNAIL_SHELL_BRICK_WALL = BLOCKS.register("snail_shell_brick_wall", () -> new WallBlock(AbstractBlock.Properties.from(SNAIL_SHELL_BRICKS.get())));
    ...
    public static final RegistryObject<Block> BEJEWELED_SNAIL_SHELL_BRICK_SLAB = BLOCKS.register("bejeweled_snail_shell_brick_slab", () -> new SlabBlock(AbstractBlock.Properties.from(SNAIL_SHELL_BRICKS.get())));
    public static final RegistryObject<Block> BEJEWELED_SNAIL_SHELL_BRICK_STAIRS = BLOCKS.register("bejeweled_snail_shell_brick_stairs", () -> new StairsBlock(SNAIL_SHELL_BLOCK.get()::getDefaultState, AbstractBlock.Properties.from(SNAIL_SHELL_BLOCK.get())));
