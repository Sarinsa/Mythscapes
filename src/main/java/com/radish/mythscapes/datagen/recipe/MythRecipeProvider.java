...
public class MythRecipeProvider extends AbstractRecipeProvider {
    ...
    public void registerRecipes(@NotNull Consumer<IFinishedRecipe> consumer) {
        ...
        // Mekanism
        CombinerRecipeBuilder.combining(ItemStackIngredient.deserialize(ingredientFromName("mekanism:dust_diamond", 3)), ItemStackIngredient.from(MythItems.GALVITE.get()), new ItemStack(MythItems.BEJEWELED_GALVITE.get())).build(consumer);
        ...
        CombinerRecipeBuilder.combining(ItemStackIngredient.deserialize(ingredientFromName("mekanism:dust_gold", 8)), ItemStackIngredient.from(MythItems.GALVITE.get()), new ItemStack(MythItems.GILDED_GALVITE.get())).build(consumer);
    }
}
